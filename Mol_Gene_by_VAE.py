...
history = model.fit([adjacency_tensor, feature_tensor, qed_tensor], epochs=EPOCHS,batch_size=BATCH_SIZE)
...
z_mean=plot_latent(model, [adjacency_tensor[:8000], feature_tensor[:8000]], qed_tensor[:8000])
print(z_mean)